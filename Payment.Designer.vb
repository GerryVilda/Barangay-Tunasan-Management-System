...
Partial Class Payment
    ...
    Private Sub InitializeComponent()
        ...
        Label11.Location = New Point(14, 548)
        Label11.Margin = New Padding(4, 0, 4, 0)
        Label11.Name = "Label11"
        Label11.Size = New Size(148, 32)
        Label11.TabIndex = 55
        ...
        Panel1.Controls.Add(lblupdatedby)
        ...
        lblupdatedby.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblupdatedby.Location = New Point(228, 548)
        lblupdatedby.Margin = New Padding(4, 0, 4, 0)
        lblupdatedby.Name = "lblupdatedby"
        lblupdatedby.Size = New Size(95, 32)
        lblupdatedby.TabIndex = 56
        lblupdatedby.Text = "Label13"
        ' 
        ' lblcreatedat
        ' 
        lblcreatedat.AutoSize = True
        lblcreatedat.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblcreatedat.Location = New Point(228, 490)
        lblcreatedat.Margin = New Padding(4, 0, 4, 0)
        lblcreatedat.Name = "lblcreatedat"
        lblcreatedat.Size = New Size(95, 32)
        lblcreatedat.TabIndex = 55
        lblcreatedat.Text = "Label12"
        ' 
        ' cmbProcessed
        ' 
        ...
        cmbProcessed.Location = New Point(228, 428)
        cmbProcessed.Margin = New Padding(4)
        cmbProcessed.Name = "cmbProcessed"
        cmbProcessed.Size = New Size(492, 40)
        ...
        cmbType.Location = New Point(228, 128)
        cmbType.Margin = New Padding(4)
        cmbType.Name = "cmbType"
        cmbType.Size = New Size(492, 40)
        cmbType.TabIndex = 49
        ' 
        ' txtResidentname
        ' 
