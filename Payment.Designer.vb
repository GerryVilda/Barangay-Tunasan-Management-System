...
Partial Class Payment
    ...
    Private Sub InitializeComponent()
        ...
        Label6.Location = New Point(4, 248)
        ...
        Label8.Location = New Point(4, 330)
        ...
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(874, 391)
        Panel1.TabIndex = 56
        ' 
        ' txtresidentname
        ' 
        txtresidentname.Font = New Font("Segoe UI Semibold", 16F, FontStyle.Bold)
        txtresidentname.Location = New Point(298, 155)
        ...
        txtrequestid.Location = New Point(298, 322)
        txtrequestid.Margin = New Padding(4)
        txtrequestid.Name = "txtrequestid"
        txtrequestid.Size = New Size(493, 50)
        ...
        Label17.Location = New Point(22, 330)
        Label17.Margin = New Padding(4, 0, 4, 0)
        Label17.Name = "Label17"
        Label17.Size = New Size(186, 45)
        Label17.TabIndex = 60
        ...
        cmbSitio.Location = New Point(298, 236)
        cmbSitio.Margin = New Padding(4)
        cmbSitio.Name = "cmbSitio"
        cmbSitio.Size = New Size(493, 53)
        ...
        Label11.Location = New Point(22, 246)
        Label11.Margin = New Padding(4, 0, 4, 0)
        Label11.Name = "Label11"
        Label11.Size = New Size(92, 45)
        Label11.TabIndex = 58
        Label11.Text = "Sitio:"
        ' 
        ' Label10
        ...
        cmbcertificateType.Location = New Point(298, 71)
        cmbcertificateType.Margin = New Padding(4)
        cmbcertificateType.Name = "cmbcertificateType"
        cmbcertificateType.Size = New Size(493, 53)
        ...
        btnPaid.Font = New Font("Segoe UI Semibold", 14F, FontStyle.Bold)
        btnPaid.ForeColor = Color.Black
        btnPaid.Location = New Point(632, 2)
        btnPaid.Margin = New Padding(4)
        btnPaid.Name = "btnPaid"
        btnPaid.Size = New Size(131, 59)
        btnPaid.TabIndex = 57
        btnPaid.Text = "Paid"
        ...
        Panel3.Location = New Point(1002, 94)
        Panel3.Margin = New Padding(4)
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(779, 391)
        Panel3.TabIndex = 59
        ' 
        ' btndeletepending
        ' 
        btndeletepending.BackColor = Color.Red
        btndeletepending.FlatAppearance.BorderSize = 0
        btndeletepending.FlatStyle = FlatStyle.Flat
        btndeletepending.Font = New Font("Segoe UI Semibold", 14F, FontStyle.Bold)
        btndeletepending.ForeColor = Color.Black
        btndeletepending.Location = New Point(493, 4)
        btndeletepending.Margin = New Padding(4)
        btndeletepending.Name = "btndeletepending"
        btndeletepending.Size = New Size(131, 59)
        btndeletepending.TabIndex = 61
        btndeletepending.Text = "Delete"
        ...
        Panel2.Location = New Point(31, 519)
        Panel2.Margin = New Padding(4)
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(874, 546)
        Panel2.TabIndex = 61
        ' 
        ' cbostatus
        ' 
        ...
        Label16.Location = New Point(22, 328)
        Label16.Margin = New Padding(4, 0, 4, 0)
        Label16.Name = "Label16"
        Label16.Size = New Size(147, 45)
        Label16.TabIndex = 67
        ...
        Label15.Location = New Point(22, 160)
        Label15.Margin = New Padding(4, 0, 4, 0)
        Label15.Name = "Label15"
        Label15.Size = New Size(118, 45)
        Label15.TabIndex = 65
        Label15.Text = "Status:"
        ' 
        ' Label7
        ...
        Label13.Location = New Point(22, 245)
        Label13.Margin = New Padding(4, 0, 4, 0)
        Label13.Name = "Label13"
        Label13.Size = New Size(179, 45)
        Label13.TabIndex = 61
        ...
        dtgforpayments.Location = New Point(1002, 563)
        dtgforpayments.Margin = New Padding(2)
        dtgforpayments.Name = "dtgforpayments"
        dtgforpayments.ReadOnly = True
        dtgforpayments.RowHeadersWidth = 62
        dtgforpayments.Size = New Size(779, 227)
        ...
        dgvtransactions_history.Location = New Point(1002, 863)
        ...
        dgvtransactions_history.Size = New Size(779, 202)
        dgvtransactions_history.TabIndex = 63
        ' 
        ' Pending
        ' 
        Pending.AutoSize = True
        Pending.Font = New Font("Segoe UI Semibold", 16F, FontStyle.Bold)
        Pending.Location = New Point(1002, 507)
        Pending.Margin = New Padding(4, 0, 4, 0)
        Pending.Name = "Pending"
        Pending.Size = New Size(226, 45)
        Pending.TabIndex = 62
        Pending.Text = "For payments:"
        ' 
        ' Label9
        ' 
        Label9.AutoSize = True
        Label9.Font = New Font("Segoe UI Semibold", 16F, FontStyle.Bold)
        Label9.Location = New Point(1002, 807)
        Label9.Margin = New Padding(4, 0, 4, 0)
        Label9.Name = "Label9"
        Label9.Size = New Size(338, 45)
        Label9.TabIndex = 64
        Label9.Text = "Finished Transactions:"
        ' 
        ' Payment
        ' 
    ...
    Friend WithEvents btndeletepending As Button
