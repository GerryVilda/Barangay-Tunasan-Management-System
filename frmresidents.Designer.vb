...
Partial Class frmresidents
    ...
    Private Sub InitializeComponent()
        ...
        Label5.Location = New Point(1093, 184)
        ...
        Label6.Location = New Point(1080, 130)
        ...
        ' btnadd
        ' 
        btnadd.Location = New Point(1833, 44)
        ...
        ' btnupdate
        ' 
        btnupdate.Location = New Point(1833, 110)
        ...
        ' btndelete
        ' 
        btndelete.Location = New Point(1833, 176)
        ...
        cbositio.Location = New Point(1202, 130)
